...
import com.example.android.consumerapp.adapter.ConsumerAdapter;
...
import static com.example.android.consumerapp.MappingHelper.mapCursorToArrayList;
...
public class MainActivity extends AppCompatActivity implements LoadNotesCallback{
    ...
    // Line ini mempunyai fungsi hampir sama dengan LoadNotesAsync di MyNotesApp
    private static class getData extends AsyncTask<Void, Void, Cursor>{
        private final WeakReference<Context> weakContext;
        private final WeakReference<LoadNotesCallback> weakCallback;

        private getData(Context context, LoadNotesCallback loadNotesCallback){
    ...
    // class tsb berguna sbg listener ketika ada perubahan data dan
    // menjalankan fungsi AsyncTask scr otomatis
